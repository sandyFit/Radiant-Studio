const bioData = [
    ...
    
    {
        ...
        firstName: "Nathan",
        lastName: "Roberts",
        bio: "Dr. Roberts is the founder and owner of Radiant Dental Studio. He attended the University of Pittsburgh, he enrolled in a seven-year accelerated program that earned him both a Bachelor of Science in general chemistry and biology and a Doctorate of Medicine in Dentistry (DMD). \n\nDr. Roberts's expertise ranges from general exams and preventive care to more complex cosmetic procedures such as dental implants, veneers, and Invisalign®.  \n\nHe works closely with her patients to develop individualized plans that address their goals, health considerations, and budgets."
    },
...

    {
        ...
        firstName: "Judy",
        lastName: "Woods",
        bio: "Judy is a 2012 graduate of the Dental Hygiene Program at Hudson Valley Community College, and an active member of the American Dental Hygiene Association. \n\nShe has been an instrumental part of this practice for over 4 years, and has developed a trusting relationship with our patients while achieving the highest level of oral health. \n\nJudy has completed training at the Schuster Center for Professional Development in Scottsdale. She attends many continuing education classes and is always striving to gain more knowledge for the benefit of her patients."
    },
